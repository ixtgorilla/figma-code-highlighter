const tomorrowNight = {
  ...
  "hljs-variable": { type: "SOLID", color: { r: 0.8, g: 0.4, b: 0.4 } },
  "hljs-template-variable": {
    type: "SOLID",
    color: { r: 0.8, g: 0.4, b: 0.4 }
  },
  "hljs-tag": { type: "SOLID", color: { r: 0.8, g: 0.4, b: 0.4 } },
  "hljs-name": { type: "SOLID", color: { r: 0.8, g: 0.4, b: 0.4 } },
  "hljs-selector-id": { type: "SOLID", color: { r: 0.8, g: 0.4, b: 0.4 } },
  "hljs-selector-class": { type: "SOLID", color: { r: 0.8, g: 0.4, b: 0.4 } },
  "hljs-regexp": { type: "SOLID", color: { r: 0.8, g: 0.4, b: 0.4 } },
